...
/**
 * Servlet implementation class choxacnhancontroller
 */
@WebServlet("/choxacnhancontroller")
public class choxacnhancontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public choxacnhancontroller() {
		super();
