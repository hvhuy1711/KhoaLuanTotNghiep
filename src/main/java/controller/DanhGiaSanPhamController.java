...
/**
 * Servlet implementation class DanhGiaSanPhamController
 */
@WebServlet("/DanhGiaSanPhamController")
public class DanhGiaSanPhamController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher("DanhGiaSanPham.jsp");
