...
/**
 * Servlet implementation class TTChuyenKhoanController
 */
@WebServlet("/TTChuyenKhoanController")
public class TTChuyenKhoanController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TTChuyenKhoanController() {
        super();
