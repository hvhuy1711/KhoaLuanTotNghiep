			...
			<div class="col-sm-12 text-left">
				...
				<div class="row"
					...
					<div>
						...
						<a href="adminxacnhanspkhcontroller?btnDonDat&mact=<%=dsadmin.get(i).getMaChiTiet()%>" onclick="disableButton(this)"
							style="border: 1px solid #ccc; text-decoration: none;font-weight:bold; padding: 9px 18px; display: block; float: right; margin-bottom: 20px; margin-right: 65px; background-color: red; color: #fff; border-radius: 10px">Hủy Xác
							nhận</a>
