...
<!-- Body -->
	...
	<form action="adminCapNhatSanPhamController" method="post"
		enctype="multipart/form-data" style="margin-top: 140px"></form>
	<%
	} else {
	%>
	<form action="adminThemSanPhamController" method="post"
		enctype="multipart/form-data" style="margin-top: 140px">
		<%
		}
		%>
		...
		<div class="form-row">
			...
			<span class="labelspan">Chiếc khấu:</span> <input class="input"
				...
				placeholder="Nhập chiếc khấu" required="required"> <br>
			<%
			} else {
			%>
			<span class="labelspan">Chiếc khấu:</span> <input class="input"
				name="giamoi" type="text" value="" placeholder="Nhập chiếc khấu" required="required">
			<br>
			<%
			}
			%>
