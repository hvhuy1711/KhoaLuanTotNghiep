	...
	<%--  <div id="header">
        ...
        <ul id = "nav">
          ...
          <li><a href="sanphamcontroller">Trang Chủ</a></li>
           ...
           <li class="active"><a href="giospcontroller">Giỏ Hàng</a>
           <%
           ArrayList<giospbean> dsgio = (ArrayList<giospbean>)request.getAttribute("dsgio");
         ...
         <ul class="nav navbar-nav navbar-right ">
		        ...
		        <li>
						...
						if (session.getAttribute("dn") != null){ 
							khachhangthibean kh = (khachhangthibean) session.getAttribute("dn");
						%>
						<a href = "" style="color:white"><span style=" display: inline-block;width: 20px; background-color: pink; color: white; border-radius: 50%; text-align: center; margin-right: 5px; font-weight: 600;" ><%=kh.getHoTen().toUpperCase().charAt(0)%></span><%=kh.getHoTen() %> </a> 
						<%}else{%>
        ...
        <ul id = "nav-mobile">
           ...
           <li  class="active"><a href="giospcontroller" class="nav-mobile-css">Giỏ Hàng</a></li>
           <li><a href="thanhtoanspcontroller" class="nav-mobile-css">Thanh Toán</a></li>
           <li><a href="choxacnhancontroller" class="nav-mobile-css">Chờ xác nhận</a></li>
	...
	<div class="container" style="top: 150px; position: relative;">
		<div class="row">
			<div class="col-sm-1">
				...
				%><p>
					<a href="sanphamcontroller?ml=<%=loai.getMaLoai()%>"> <%=loai.getTenLoai()%>
					</a>
				</p>
				<%
				}
